""" 
Entradas: dados.npy e saida_esperada.npy
Saídas:   model-[0-9]*.model
"""
...
data = np.load('dados.npy')
target = np.load('saida_esperada.npy')
...
print("Acuracia final: " + model.evaluate(test_data, test_target))
